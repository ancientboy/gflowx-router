...
export const FAQ_ITEMS: { q: string; a: string }[] = [
  ...
  {
    q: '「场景管理」在网页上哪里看？',
    a: '应用后端补丁后，在 new-api 默认 Web 侧栏有「场景路由」（/gflowx-scenes），可查看说明与当前账号的模型池预览；接口 GET /api/gflowx/scene-pools 返回同一套候选列表快照。本落地页「场景管理」区块为产品向摘要。',
  },
  {
    q: '如何获得账号？',
    a: '默认由部署方在 new-api 管理后台创建用户与额度；若已开启自助注册，请使用部署方提供的注册地址。落地页「套餐与开通」中的按钮会先引导你登录。',
  },
  {
    q: '许可证要注意什么？',
